...
DATABASE_LOC = "database\\database.json"
PROMO_DATABASE_LOC = "database\\promos.json"
USERNAME_DATABASE_LOC = "database\\usernames.json"
GROUP_DATABASE_LOC = "database\\groupnames.json"
