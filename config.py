...
ROLES = {
    ...
    1: ("Тестировщик", "Роль, выдающаяся за участие в тестировании бота.\nОсобенности:\n- доступны промокоды, недоступные остальным игрокам."),
    2: ("Админ", "Роль, выдаваемая только доверенным лицам и только разработчиком бота.\nОсобенности:\n- доступны промокоды, недоступные остальным игрокам;\n- может создавать новые промокоды;\n- может изменять роли обычных игроков и Тестировщиков. Подробную информацию можно узнать через команду /admin_features в личных сообщениях."),
    3: ("Главный админ", "Роль разработчика бота.\nОсобенности:\n- доступны промокоды, недоступные остальным игрокам;\n- может создавать новые промокоды;\n- может выдавать роли другим игрокам (вплоть до Админа). Подробную информацию можно узнать через команду /developer_features в личных сообщениях.")
}
